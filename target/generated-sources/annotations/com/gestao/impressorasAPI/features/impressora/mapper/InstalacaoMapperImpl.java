...
public class InstalacaoMapperImpl implements InstalacaoMapper {
    ...
    public InstalacaoEntity toEntity(InstalacaoDTO instalacaoDTO) {
        ...
        instalacaoEntity.rua( instalacaoDTO.rua() );
        instalacaoEntity.numero( instalacaoDTO.numero() );
        instalacaoEntity.bairro( instalacaoDTO.bairro() );
